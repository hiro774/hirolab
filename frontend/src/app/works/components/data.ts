...
export const worksData: WorkType[] = [
  {
    id: 2,
    title: "Ohtani Report AI",
    description: "OpenAI APIを使用した会話型AIアシスタント",
    thumbnail: "/images/thumbnail/ReportAi_thumbnail.png",
    previewImage: ["/images/thumbnail/ReportAi_thumbnail.png"],
  ...
  },
  {
    ...
    previewImage: [
      "/images/thumbnail/hirolab_thumbnail.png",
