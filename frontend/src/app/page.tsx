...
export default function Home() {
  return (
    <div className="mt-13 min-h-screen flex flex-col items-center justify-center animate-fadeIn">
      <section className="text-center pt-8 md:pt-0">
        ...
        <div>
          <Link href="/ai" className="btn btn-ghost btn-lg">
        ...
        <div className="md:mt-10 mb-25 flex justify-center gap-5">
          ...
          <Link
            ...
            className="btn btn-circle btn-ghost btn-lg w-15 h-15"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
