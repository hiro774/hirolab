  ...
  return (
    <header className="navbar bg-white/70 backdrop-blur-md border border-white/20 shadow-md fixed top-0 z-50 px-6 animate-[fadeIn_0.5s_ease_forwards] relative">
      <div className="navbar-start">
        ...
        <Link
          href="/"
          className="btn btn-ghost normal-case text-2xl font-bold flex items-center"
        >
          ...
          <div className="mt-2 w-40 h-20 flex items-center justify-center">
            <Image
          ...
          <ul className="menu menu-horizontal px-1 gap-1 flex-nowrap">
            <li>
              ...
              >
                ...
                <span className="text-black text-base font-medium">Top</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span className="text-black text-base font-medium">About</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <Link
                href="/works"
                className="btn btn-ghost btn-sm rounded-full text-lg flex items-center gap-3 px-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                ...
                <span className="text-black text-base font-medium">Works</span>
              </Link>
            </li>
            <li>
              <Link
