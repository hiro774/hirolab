    ...
    <header className="navbar bg-white/70 backdrop-blur-md border border-white/20 shadow-md fixed top-0 z-50 px-6 animate-fadeIn">
          ...
          <ul className="menu menu-horizontal px-1 gap-4 flex-nowrap">
            <li>
              ...
              >
                ...
                <span className="text-gray-700 text-base font-medium">Top</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              ...
              >
                ...
                <span className="text-gray-700 text-base font-medium">AI</span>
              </Link>
            </li>

            {/* <li className="menu-accent">
              <Link
                href=""
      ...
      <div className="navbar-end hidden xl:flex gap-4 mr-5 menu menu-horizontal menu-accent">
        ...
        >
          ...
          <span className="text-gray-700 text-base font-medium">Contact</span>
        </Link>
      </div>
    </header>
  );
